...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Shailesh Khandate',
    title: 'Android Developer | Full-Stack Developer | Problem Solver',
    skills: [
        'Java', 'Python','Kotlin', 'React', 'NextJS', 'Express',
  ...
  return (
    <>
      ...
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <path d="M12 0C5.37 0 0 5.373 0 12a12 12 0 008.205 11.387c.6.111.793-.261.793-.577v-2.07c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.09-.746.083-.73.083-.73 1.205.085 1.838 1.238 1.838 1.238 1.07 1.834 2.809 1.304 3.495.997.108-.775.42-1.305.762-1.605-2.665-.304-5.466-1.334-5.466-5.933 0-1.311.47-2.382 1.236-3.22-.124-.303-.535-1.523.116-3.176 0 0 1.008-.322 3.3 1.23a11.52 11.52 0 013.003-.403c1.02.005 2.048.137 3.003.403 2.29-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.873.118 3.176.77.838 1.234 1.909 1.234 3.22 0 4.61-2.804 5.625-5.475 5.922.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.8.576A12.003 12.003 0 0024 12c0-6.627-5.373-12-12-12z" />
      </svg>
      {/* GitHub Label */}
      <span>GitHub</span>
                    </span>
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/17TM0HWM84rgCVwQlTZ2DAnJ5cFqD0KFq/view?usp=drive_link"
