...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "b7cf710e-704a-49a8-b868-cea115a35553"); // Replace with your Web3Forms access key
 ...
 text-white min-h-screen"
    >
      <section className="hero flex items-center relative px-4 sm:px-6 lg:px-8 pt-16 pb-0">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">shaileshkhandate2002@gmail.com</p>
                  </div>
                </div>
